...
public class GuiAdvancedHUD extends GuiIngame {
    ...
    public static int[] hotbarPosition = {0,0};
    public static int[] bossHealthPosition = {0,0};
    public static int[] healthPosition = {0,0};
    public static int[] armorPosition = {0,0};
    public static int[] foodPosition = {0,0};
    public static int[] airPosition = {0,0};
    public static int[] experiencePosition = {0,0};
    public static int[] objectivePosition = {0,0};
    public static int[] recordPosition = {0,0};
    
    public static int[] hotbarDimensions = {182,22};
    public static int[] bossHealthDimensions = {182,5};
    public static int[] healthDimensions = {81,9};
    public static int[] armorDimensions = {81,9};
    public static int[] foodDimensions = {81,9};
    public static int[] airDimensions = {81,9};
    public static int[] experienceDimensions = {182,5};
    public static int[] objectiveDimensions = {48,48};
    public static int[] recordDimensions = {182,12};
    ...
    public void renderGameOverlay(float partialTicks, boolean hasScreen, int mouseX, int mouseY)
    {
        ...
        if (!positionLoaded) {
            if (AdvancedHUD.configFile.exists()) {
                hotbarPosition = loadPosition("hotbar");
                bossHealthPosition = loadPosition("bosshealth");
                healthPosition = loadPosition("health");
                armorPosition = loadPosition("armor");
                foodPosition = loadPosition("food");
                airPosition = loadPosition("air");
                experiencePosition = loadPosition("experience");
                objectivePosition = loadPosition("objective");
                recordPosition = loadPosition("record");
            } else {
                hotbarPosition[0] = 0;
                hotbarPosition[1] = 0;
                bossHealthPosition[0] = 0;
                bossHealthPosition[1] = 0;
                healthPosition[0] = 0;
                healthPosition[1] = 0;
                armorPosition[0] = 0;
                armorPosition[1] = 0;
                ...
                airPosition[0] = 0;
                airPosition[1] = 0;
                experiencePosition[0] = 0;
                experiencePosition[1] = 0;
        ...
        if (!mc.playerController.enableEverythingIsScrewedUpMode())
        {
            ...
            GL11.glPushMatrix();
            GL11.glTranslatef(bossHealthPosition[0], bossHealthPosition[1], 0F);
            ...
            {
                GL11.glPushMatrix();
                GL11.glTranslatef(armorPosition[0], armorPosition[1], 0F);
                if (renderArmor)  renderArmor(width, height);
                GL11.glPopMatrix();

                GL11.glPushMatrix();
                GL11.glTranslatef(healthPosition[0], healthPosition[1], 0F);
                if (renderHealth) renderHealth(width, height);
                GL11.glPopMatrix();

                GL11.glPushMatrix();
                GL11.glTranslatef(foodPosition[0], foodPosition[1], 0F);
                if (renderFood)   renderFood(width, height);
                GL11.glPopMatrix();

                GL11.glPushMatrix();
                GL11.glTranslatef(airPosition[0], airPosition[1], 0F);
                if (renderAir)    renderAir(width, height);
                GL11.glPopMatrix();
            }
            GL11.glPushMatrix();
            GL11.glTranslatef(hotbarPosition[0], hotbarPosition[1], 0F);
            if (renderHotbar) renderHotbar(width, height, partialTicks);
            GL11.glPopMatrix();
        }

        GL11.glPushMatrix();
        GL11.glTranslatef(experiencePosition[0], experiencePosition[1], 0F);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(recordPosition[0], recordPosition[1], 0F);
        ...
        {
            GL11.glPushMatrix();
            GL11.glTranslatef(objectivePosition[0], objectivePosition[1], 0F);
    ...
    public static int[] loadPosition(String object) {
        NBTTagCompound cmp = getTagCompoundInFile(AdvancedHUD.configFile);
        
        if (!cmp.hasKey("config"))
            return new int[] {0,0};
        NBTTagCompound configCmp = cmp.getCompoundTag("config");
        
        if (!configCmp.hasKey(object))
            return new int[] {0,0};
        NBTTagCompound objectCmp = configCmp.getCompoundTag(object);
        
        if (!configCmp.hasKey("position"))
            return new int[] {0,0};
        NBTTagCompound positionCmp = objectCmp.getCompoundTag("position");

        int posX = positionCmp.getInteger("posX");
        int posY = positionCmp.getInteger("posY");
