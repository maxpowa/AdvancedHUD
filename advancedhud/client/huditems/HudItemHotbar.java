...
public class HudItemHotbar extends HudItem {
    ...
    public void render(float partialTicks) {
        ...
        RenderAssist.drawTexturedModalRect(posX - 1 + inv.currentItem * 20, posY - 1, 0, 22, 24, 22);
     ...
     */
    protected void renderInventorySlot(int par1, int par2, int par3, float par4, Minecraft mc)
    {
